...
public class  HotelPremier extends Application {
    ...
    private void precargarEscenas (){
        ...
        SceneManager.precargarEscena("reservar_hab1", "/views/interfaces/reservar-habitacion/reservar-habitacion-2.fxml");
        ...
        SceneManager.registrarEscena("reservar_hab2", "/views/interfaces/reservar-habitacion/reservar-habitacion-1.fxml");
